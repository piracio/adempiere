...
//		this.setWidth("500px");
	...
	private CustomGrid kLayout = GridFactory.newGridLayout();
	...
	private CustomGrid sPanelLayout = GridFactory.newGridLayout();
	...
	private CustomGrid bPanelLayout = GridFactory.newGridLayout();
	...
	private CustomGrid pPanelLayout = GridFactory.newGridLayout();
	private Label bCashBookLabel = new Label();
	private Listbox bCashBookCombo = ListboxFactory.newDropdownListbox();
	private CustomGrid tPanelLayout = GridFactory.newGridLayout();
